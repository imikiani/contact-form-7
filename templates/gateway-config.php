...
if ( isset( $_POST['update'] ) ) {
	...
	_e( "Settings Updated.", 'idpay-contact-form-7' );
	echo "</strong></p></div>";
}
...
$success_message = ( ! empty( $value['success_message'] ) ? $value['success_message'] : __( 'Your payment has been successfully completed. Tracking code: {track_id}', 'idpay-contact-form-7' ) );
$failed_message  = ( ! empty( $value['failed_message'] ) ? $value['failed_message'] : __( 'Your payment has failed. Please try again or contact the site administrator in case of a problem.', 'idpay-contact-form-7' ) );
